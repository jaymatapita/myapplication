...
export class SearchComponent implements OnInit {
  ...
  searchUser() {
    ...
    this.appService.getGitHubUser(this.userName)
      .subscribe((userData: any) => {
        ...
        if (localStorage.getItem('successfullUsers')) {
          ...
          localStorage.setItem('successfullUsers', JSON.stringify(successfullUsers));
        }
        else {
          successfullUsers.push(this.user)
          localStorage.setItem('successfullUsers', JSON.stringify(successfullUsers));
        ...
        if (localStorage.getItem('unSuccessfullUsers')) {
          ...
          localStorage.setItem('unSuccessfullUsers', JSON.stringify(unSuccessfullUsers));
        }
        else {
          unSuccessfullUsers.push(user);
          localStorage.setItem('unSuccessfullUsers', JSON.stringify(unSuccessfullUsers));
